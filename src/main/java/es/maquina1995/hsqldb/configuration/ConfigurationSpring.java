 ...
 * <p>
 * <a href= "https://www.logicbig.com/how-to/code-snippets/jcode-spring-framework-componentscan-filter.html">Documentación ComponentScan por regExp y mas</a>
 * 
 * @author MaQuiNa1995
 *
 */
...
public class ConfigurationSpring
{
	 ...
	 * @param dataSource {@link DataSource} bean que representa la conexión a la base de datos
	 * 
	 * @return {@link LocalContainerEntityManagerFactoryBean} objeto encargado de la persistencia en base de datos
	 */
	@Bean
	 ...
	 * 
	 * @return {@link HibernateJpaVendorAdapter} Objeto que contiene las propieades adicionales que podemos usar en jpa/hibernate
	 */
