...
@ComponentScan(basePackages = "es.maquina1995.hsqldb.", useDefaultFilters = true,
    includeFilters = @Filter(type = FilterType.REGEX, pattern = "(repository|service)$"))
public class ConfigurationSpring {
  // private static final String PROPERTY_NAME_HIBERNATE_DIALECT =
  // "org.hibernate.dialect.HSQLDialect";
  // private static final String PROPERTY_NAME_HIBERNATE_MAX_FETCH_DEPTH =
  // "hibernate.max_fetch_depth";
  // private static final String PROPERTY_NAME_HIBERNATE_JDBC_FETCH_SIZE =
  ...
  /**
   * Bean que representa la clase encargada de las transacciones en la base de datos
   * 
   * @param dataSource {@link DataSource} bean que representa la conexión a la base de datos
   * 
   * @return {@link JpaTransactionManager} encargado de las transaciones en la base de datos
   */
  @Bean
   ...
   * @param dataSource {@link DataSource} bean que representa la conexión a la base de datos
   * 
   * @return {@link LocalContainerEntityManagerFactoryBean} objeto encargado de la persistencia en
   *         base de datos
   */
  @Bean
   ...
   * 
   * @return {@link HibernateJpaVendorAdapter} Objeto que contiene las propieades adicionales que
   *         podemos usar en jpa/hibernate
   */
  ...
  // *
  // * @return {@link Properties} Objeto que contiene propiedades tipicas de hibernate y Jpa
  // */
